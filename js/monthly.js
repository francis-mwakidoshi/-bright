...
/*
Monthly 2.0.7 by Kevin Thornbloom is licensed under disablePast a Creative Commons Attribution-ShareAlike 4.0 International License.
*/
		...
		$(document.body).on('click', '#'+uniqueId+' a.monthly-day', function (e) {
			...
			// If picker, pick date
				...
				if($(this).hasClass('monthly-past-day') && options.disablePast == true) {
					...
					var CompleteDate='' + setMonth+'/'+whichDay+'/'+setYear+'';
					   get_records(CompleteDate);
